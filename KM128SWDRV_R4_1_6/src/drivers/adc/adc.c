...
{
  if ((ADC_SC1A & ADC_SC1_COCO_MASK) && (ADC_SC1A & ADC_SC1_AIEN_MASK))
  {
    pCallbackADC (CHA_CALLBACK, ADC_RA);
  }
  if ((ADC_SC1B & ADC_SC1_COCO_MASK) && (ADC_SC1B & ADC_SC1_AIEN_MASK))
  {
    pCallbackADC (CHB_CALLBACK, ADC_RB);
  }
  if ((ADC_SC1C & ADC_SC1_COCO_MASK) && (ADC_SC1C & ADC_SC1_AIEN_MASK))
  {
    pCallbackADC (CHC_CALLBACK, ADC_RC);
  }
  if ((ADC_SC1D & ADC_SC1_COCO_MASK) && (ADC_SC1D & ADC_SC1_AIEN_MASK))
  {
    pCallbackADC (CHD_CALLBACK, ADC_RD);
  }
}
/******************************************************************************
 * End of module                                                              *
