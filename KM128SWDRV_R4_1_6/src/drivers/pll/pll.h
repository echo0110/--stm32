 ...
 * @details This macro disables PLL module by clearing MCG_C5[PLLCLKEN0] and
 *          setting MCG_C2[LP] bits.
 * @note    Implemented as an inline macro.
 * @see     @ref PLL_Enable
 ******************************************************************************/
#define PLL_Disable()                                                         \
{                                                                             \
  iosetb (MCG_C2,MCG_C2_LP_MASK);                                             \
  ioclrb (MCG_C5,MCG_C5_PLLCLKEN0_MASK);                                      \
}
