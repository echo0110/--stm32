 ...
 * @details This macro sets new communication baudrate.
...
{                                                                             \
  register uint16 __tmp1= CALC_SBR (brate,clk);                               \
  register uint16 __tmp2= CALC_BRFA(brate,clk);                               \
  iobfib(module##_BDH,UART_BDH_SBR_SHIFT,5,((__tmp1>>8)&0x1f));               \
  iobfib(module##_BDL,UART_BDL_SBR_SHIFT,8,((__tmp1>>0)&0xff));               \
  iobfib(module##_C4,UART_C4_BRFA_SHIFT,5,((__tmp2>>0)&0x1f));                \
}
